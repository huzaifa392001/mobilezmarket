...
const ProfileLayout = (props) => {
  ...
  const getDevices = async (data, isNewData, newPage) => {
    try {
      ...
      let getCategores = res?.data?.category?.map((item) => {
        return {
          label: item?.category,
          value: item?.category,
        };
      ...
      <div className="content_wrap">
        <div className='profile_content'>
          ...
          <div className="shop_ads_result">
            ...
            <div className="shop_profile_mobile">
              <ShopProfile total={total} data={profile} />
            </div>
            <div className="product_result_row">
